...
from flamezo_backend.flamezo_backend.pos.base import POSProvider
from flamezo_backend.flamezo_backend.utils.common import safe_log_error
...
class PetpoojaProvider(POSProvider):
    ...
    def handle_callback(self, data):
        ...
        try:
            ...
            from flamezo_backend.flamezo_backend.api.realtime import notify_order_update
    ...
    def map_status(self, provider_status):
        ...
        """
        from flamezo_backend.flamezo_backend.pos.base import DineMattersOrderStatus
    ...
    def _format_order(self, order_doc):
        ...
        callback_url = get_url("/api/method/flamezo_backend.flamezo_backend.api.pos.petpooja_callback")
