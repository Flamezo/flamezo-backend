...
from flamezo_backend.flamezo_backend.utils.roles import GLOBAL_ADMIN_ROLES, SUPERVISOR_ROLES
...
def _resolve_restaurant(restaurant_id):
	...
	from flamezo_backend.flamezo_backend.utils.api_helpers import get_restaurant_from_id
