...
from flamezo_backend.flamezo_backend.media.utils import format_media_field


@frappe.whitelist(allow_guest=True)
def get_events(restaurant_id, featured=None, category=None, upcoming_only=True):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.events.get_events
...
def save_event(restaurant_id, event_data):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.events.save_event
...
def delete_event(restaurant_id, event_id):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.events.delete_event
	Delete an event
	"""
	try:
		# Validate restaurant and user access
...
def toggle_event_status(restaurant_id, event_id, field):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.events.toggle_event_status
