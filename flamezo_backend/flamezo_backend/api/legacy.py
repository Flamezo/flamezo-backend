...
from flamezo_backend.flamezo_backend.media.utils import get_media_asset_data
from flamezo_backend.flamezo_backend.services.ai.legacy_generation import LegacyGenerator, clean_description, infer_cuisine_identity
import json
...
def get_legacy_content(restaurant_id):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.legacy.get_legacy_content
...
def update_legacy_content(restaurant_id, hero=None, content=None, signature_dishes=None, testimonials=None, members=None, gallery=None, instagram_reels=None, footer=None):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.legacy.update_legacy_content
...
def generate_legacy_content(restaurant_id):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.legacy.generate_legacy_content
