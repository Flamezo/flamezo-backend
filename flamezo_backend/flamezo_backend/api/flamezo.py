...
def get_all_restaurants(latitude=None, longitude=None, search=None, city=None, page=1, limit=30):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.flamezo.get_all_restaurants
...
def get_cross_restaurant_offers(city=None, page=1, limit=30):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.flamezo.get_cross_restaurant_offers
...
def get_flamezo_member(phone=None):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.flamezo.get_flamezo_member
...
def get_points_ledger(phone=None, page=1, limit=20):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.flamezo.get_points_ledger
...
def register_flamezo_member(phone, full_name=None, city=None):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.flamezo.register_flamezo_member
...
def get_restaurant_summary(restaurant_id):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.flamezo.get_restaurant_summary
