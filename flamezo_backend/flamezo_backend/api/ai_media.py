...
from flamezo_backend.flamezo_backend.media.storage import upload_object, get_cdn_url, generate_object_key
...
def enqueue_enhancement(restaurant, owner_doctype, owner_name, original_image_url=None, mode="enhance", include_branding=False):
    ...
    frappe.enqueue(
        "flamezo_backend.flamezo_backend.api.ai_media.process_ai_image_enhancement",
        queue="default",
        timeout=300,
...
def process_ai_image_enhancement(generation_name, mode="enhance", include_branding=False, coins_to_refund=0):
    ...
    from flamezo_backend.flamezo_backend.api.coin_billing import refund_coins
