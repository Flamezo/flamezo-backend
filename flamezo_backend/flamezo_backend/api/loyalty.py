...
def get_loyalty_summary(restaurant_id, phone):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.loyalty.get_loyalty_summary
	...
	try:
		...
		from flamezo_backend.flamezo_backend.utils.loyalty import get_loyalty_balance, get_loyalty_tier
...
def generate_referral_link(restaurant_id, phone, platform="WhatsApp"):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.loyalty.generate_referral_link
	...
	try:
		...
		from flamezo_backend.flamezo_backend.utils.config_helpers import get_app_base_url
...
def track_referral_visit(identifier, ip_address=None, user_agent=None):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.loyalty.track_referral_visit
...
def claim_referral_reward(restaurant_id, referral_id, phone):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.loyalty.claim_referral_reward
...
def get_referral_details(identifier):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.loyalty.get_referral_details
...
def credit_loyalty_points(customer, restaurant, coins, reason, ref_doctype=None, ref_name=None, transaction_type="Earn"):
	...
	from flamezo_backend.flamezo_backend.utils.loyalty import add_loyalty_coins, redeem_loyalty_coins
