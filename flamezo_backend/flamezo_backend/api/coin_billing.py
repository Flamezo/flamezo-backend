...
from flamezo_backend.flamezo_backend.utils.razorpay_utils import get_razorpay_client, get_razorpay_config
...
def check_and_trigger_auto_recharge(restaurant, current_balance):
    ...
    frappe.enqueue(
        "flamezo_backend.flamezo_backend.api.coin_billing.trigger_auto_recharge",
        restaurant=restaurant,
