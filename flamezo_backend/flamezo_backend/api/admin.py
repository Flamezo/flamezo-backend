...
from flamezo_backend.flamezo_backend.utils.razorpay_utils import get_razorpay_client
from flamezo_backend.flamezo_backend.utils.roles import GLOBAL_ADMIN_ROLES, SUPERVISOR_ROLES, is_global_admin, is_supervisor
import json
...
def admin_onboard_restaurant_owner(restaurant_id, owner_name, owner_email):
    ...
    try:
        ...
        from flamezo_backend.flamezo_backend.utils.permissions import assign_user_to_restaurant, create_restaurant_user_permission
...
def admin_create_wallet_payment_link(restaurant_id, tier):
    ...
    try:
        ...
        try:
            from flamezo_backend.flamezo_backend.utils.whatsapp_utils import send_whatsapp_message
