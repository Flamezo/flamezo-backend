...
from flamezo_backend.flamezo_backend.utils.customization_helpers import get_customization_options_map, load_product_customizations
import json
...
def get_product_by_slug(restaurant_id, slug):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.products.get_product_by_slug
...
def update_product_order(product_orders):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.products.update_product_order
