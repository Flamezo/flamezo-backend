...
from flamezo_backend.flamezo_backend.utils.api_helpers import validate_restaurant_for_api
from flamezo_backend.flamezo_backend.utils.customer_helpers import (
	require_verified_phone, 
	get_or_create_customer,
	get_customer_token,
	validate_customer_session
)
from flamezo_backend.flamezo_backend.utils.feature_gate import require_plan
from flamezo_backend.flamezo_backend.utils.roles import is_supervisor, is_global_admin
import json
...
def create_table_booking(restaurant_id, number_of_diners, date, time_slot, customer_info=None, session_id=None):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.bookings.create_table_booking
...
def get_table_bookings(restaurant_id, status=None, date_from=None, date_to=None, page=1, limit=20, session_id=None, admin_mode=False):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.bookings.get_table_bookings
	...
	try:
		...
		if admin_mode:
			from flamezo_backend.flamezo_backend.utils.permissions import validate_restaurant_access
...
def get_available_time_slots(restaurant_id, date, number_of_diners=None):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.bookings.get_available_time_slots
...
def create_banquet_booking(restaurant_id, number_of_guests, event_type, date, time_slot, customer_info=None, session_id=None):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.bookings.create_banquet_booking
...
def get_banquet_bookings(restaurant_id, status=None, event_type=None, date_from=None, date_to=None, page=1, limit=20, session_id=None):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.bookings.get_banquet_bookings
...
def get_banquet_available_time_slots(restaurant_id, date, number_of_guests=None, event_type=None):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.bookings.get_banquet_available_time_slots
...
def confirm_booking(booking_id, restaurant_id, assigned_table=None):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.bookings.confirm_booking
...
def reject_booking(booking_id, restaurant_id, reason=None):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.bookings.reject_booking
...
def reassign_table(booking_id, restaurant_id, new_table_id):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.bookings.reassign_table
...
def mark_no_show(booking_id, restaurant_id):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.bookings.mark_no_show
...
def mark_completed(booking_id, restaurant_id):
	"""
	POST /api/method/flamezo_backend.flamezo_backend.api.bookings.mark_completed
...
def get_admin_bookings(restaurant_id, date_from=None, date_to=None, status=None, page=1, limit=50, search_query=None):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.bookings.get_admin_bookings
...
def get_restaurant_tables(restaurant_id):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.bookings.get_restaurant_tables
