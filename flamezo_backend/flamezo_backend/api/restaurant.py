...
def get_restaurant_id(restaurant_name):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.restaurant.get_restaurant_id
...
def get_restaurant_info(restaurant_id):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.restaurant.get_restaurant_info
...
def get_restaurant_tables(restaurant_id):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.restaurant.get_restaurant_tables
...
def list_restaurants(active_only=True):
	"""
	GET /api/method/flamezo_backend.flamezo_backend.api.restaurant.list_restaurants
