...
def get_whatsapp_orders(
    ...
    """
    POST /api/method/flamezo_backend.flamezo_backend.api.whatsapp_ordering.get_whatsapp_orders
...
def unlock_whatsapp_lead(restaurant_id: str, customer_phone: str, order_id=None):
    """
    POST /api/method/flamezo_backend.flamezo_backend.api.whatsapp_ordering.unlock_whatsapp_lead
...
def log_whatsapp_order(
    ...
    """
    POST /api/method/flamezo_backend.flamezo_backend.api.whatsapp_ordering.log_whatsapp_order
    ...
    try:
        ...
        for item in items:
            ...
            if customizations:
                try:
                    ...
                    from flamezo_backend.flamezo_backend.api.orders import load_customization_options
        ...
        try:
            from flamezo_backend.flamezo_backend.api.realtime import notify_whatsapp_intent
