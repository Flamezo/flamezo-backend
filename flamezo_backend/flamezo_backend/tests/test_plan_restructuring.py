...
Run with:
    bench run-tests --app flamezo_backend --module flamezo_backend.flamezo_backend.tests.test_plan_restructuring
"""
...
class TestStaffSeatLimits(unittest.TestCase):
    ...
    def test_silver_seat_limit_is_zero(self):
        from flamezo_backend.flamezo_backend.doctype.restaurant_user.restaurant_user import get_staff_seat_limit
    ...
    def test_silver_rejects_staff_insertion(self):
        ...
        from flamezo_backend.flamezo_backend.doctype.restaurant_user.restaurant_user import RestaurantUser
    ...
    def test_no_diamond_plan_in_seat_limits(self):
        ...
        from flamezo_backend.flamezo_backend.doctype.restaurant_user.restaurant_user import STAFF_SEAT_LIMITS
...
class TestFeaturePlanMap(unittest.TestCase):
    ...
    def setUp(self):
        from flamezo_backend.flamezo_backend.utils.feature_gate import FEATURE_PLAN_MAP
    ...
    def test_check_feature_access_gold_for_coupons(self):
        ...
        try:
            from flamezo_backend.flamezo_backend.utils.feature_gate import check_feature_access
...
class TestSilverBillingExemption(unittest.TestCase):
    ...
    def test_silver_skipped_by_daily_subscription_task(self):
        ...
        from flamezo_backend.flamezo_backend.tasks.subscription_tasks import process_daily_subscription_floors
...
class TestGoldBillingDefaults(unittest.TestCase):
    ...
    def test_gold_daily_floor_deduction_recorded(self):
        ...
        from flamezo_backend.flamezo_backend.api.coin_billing import record_transaction
...
class TestSubscriptionPlanUpdate(unittest.TestCase):
    ...
    def test_diamond_plan_rejected(self):
        ...
        from flamezo_backend.flamezo_backend.api.coin_billing import update_subscription_plan
...
class TestPlanSpecificErrorMessages(unittest.TestCase):
    ...
    def test_marketing_campaign_plan_error_mentions_gold(self):
        ...
        from flamezo_backend.flamezo_backend.doctype.marketing_campaign.marketing_campaign import MarketingCampaign
