...
Run with:
    bench run-tests --app flamezo_backend --module flamezo_backend.flamezo_backend.tests.test_coin_billing
"""
...
class TestGetBonusUnits(unittest.TestCase):
    ...
    def setUp(self):
        from flamezo_backend.flamezo_backend.api.coin_billing import get_bonus_units
...
class TestRecordTransaction(unittest.TestCase):
    ...
    @patch("flamezo_backend.flamezo_backend.api.coin_billing.check_and_trigger_auto_recharge")
...
class TestCheckAndTriggerAutoRecharge(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from flamezo_backend.flamezo_backend.api.coin_billing import check_and_trigger_auto_recharge
...
class TestCreditAutoPayCoinsIdempotency(unittest.TestCase):
    ...
    def setUp(self):
        ...
        clear_transactions(self._res_name)
        from flamezo_backend.flamezo_backend.api.coin_billing import _credit_autopay_coins
...
class TestProcessReferralBonus(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from flamezo_backend.flamezo_backend.api.coin_billing import process_referral_bonus
