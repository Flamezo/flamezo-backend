...
Run with:
    bench run-tests --app flamezo_backend --module flamezo_backend.flamezo_backend.tests.test_coupons
"""
...
class TestGetCouponDetails(unittest.TestCase):
    ...
    def _call(self, coupon_code, cart_total=200, customer_id=None, cart_items=None):
        from flamezo_backend.flamezo_backend.api.coupons import get_coupon_details
    ...
    def test_invalid_day_of_week(self):
        ...
        with patch("flamezo_backend.flamezo_backend.api.coupons.now_datetime") as mock_now:
...
class TestValidateOfferEligibility(unittest.TestCase):
    ...
    def _call(self, offer, cart_total=200, customer_id=None, cart_items=None, delivery_type=None, delivery_fee=0):
        from flamezo_backend.flamezo_backend.utils.pricing import validate_offer_eligibility
    ...
    def test_wrong_day_of_week(self):
        ...
        with patch("flamezo_backend.flamezo_backend.utils.pricing.now_datetime") as mock_now:
...
class TestGetCouponsAPI(unittest.TestCase):
    ...
    def _call(self, active_only=True):
        from flamezo_backend.flamezo_backend.api.coupons import get_coupons
...
class TestGetApplicableOffersAPI(unittest.TestCase):
    ...
    def _call(self, cart_items=None, cart_total=300, customer_id=None, order_type=None):
        from flamezo_backend.flamezo_backend.api.coupons import get_applicable_offers
...
class TestCouponSchedulerTasks(unittest.TestCase):
    ...
    def test_auto_activate_coupon_with_valid_from_today(self):
        ...
        from flamezo_backend.flamezo_backend.tasks.coupon_tasks import auto_activate_scheduled_coupons
    ...
    def test_auto_deactivate_expired_coupon(self):
        ...
        from flamezo_backend.flamezo_backend.tasks.coupon_tasks import auto_deactivate_expired_coupons
...
class TestCouponExportImport(unittest.TestCase):
    ...
    def test_export_returns_csv_download(self):
        ...
        from flamezo_backend.flamezo_backend.api.coupons import export_coupons
    ...
    def test_import_creates_new_coupons(self):
        ...
        from flamezo_backend.flamezo_backend.api.coupons import import_coupons
