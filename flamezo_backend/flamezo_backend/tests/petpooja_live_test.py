...
Run: bench --site dine_matters execute flamezo_backend.flamezo_backend.tests.petpooja_live_test.run
...
def run():
    ...
    raw_url = get_url("/api/method/flamezo_backend.flamezo_backend.api.pos.petpooja_callback")
    ...
    if "localhost" in raw_url or "127.0.0.1" in raw_url:
        callback_url = "https://backend.flamezo_backend.com/api/method/flamezo_backend.flamezo_backend.api.pos.petpooja_callback"
