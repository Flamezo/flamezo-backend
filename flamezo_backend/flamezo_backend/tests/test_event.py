...
import unittest
import frappe
from flamezo_backend.flamezo_backend.tests.utils import make_restaurant, cleanup_restaurant
...
class TestEvent(unittest.TestCase):
	...
	def test_upload_session_as_restaurant(self):
		...
		from flamezo_backend.flamezo_backend.media.api import request_upload_session
