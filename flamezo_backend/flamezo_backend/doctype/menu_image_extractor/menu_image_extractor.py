...
import requests
import hashlib
from flamezo_backend.flamezo_backend.services.ai.menu_extraction import MenuExtractor, extract_and_generate
...
def extract_menu_data(docname):
	...
	try:
		...
		for batch_idx, image_batch in enumerate(image_batches):
			frappe.enqueue(
				"flamezo_backend.flamezo_backend.doctype.menu_image_extractor.menu_image_extractor._extract_batch_internal",
				docname=docname,
