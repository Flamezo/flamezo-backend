...
def dispatch_scheduled_campaigns():
    ...
    for campaign_id in pending:
        ...
        frappe.enqueue(
            "flamezo_backend.flamezo_backend.tasks.marketing_tasks.dispatch_campaign_task",
...
def fire_order_complete_triggers(order_doc, method=None):
    ...
    for trigger in triggers:
        ...
        frappe.enqueue(
            "flamezo_backend.flamezo_backend.tasks.marketing_tasks._fire_trigger_for_customer",
...
def generate_daily_seo_blog():
    ...
    """
    from flamezo_backend.flamezo_backend.services.ai.seo_blog import ContentGenerator
    import random
