...
def grant_birthday_bonuses():
	...
	from flamezo_backend.flamezo_backend.utils.loyalty import add_loyalty_coins
...
def send_coin_expiry_notifications():
	...
	from flamezo_backend.flamezo_backend.api.push_notifications import _send_fcm_message
	import json
