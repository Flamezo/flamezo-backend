...
class TestGetCouponsAPI(unittest.TestCase):
    ...
    def _call(self, active_only=True):
        from dinematters.dinematters.api.coupons import get_coupons
...
class TestCouponSchedulerTasks(unittest.TestCase):
    ...
    def test_auto_activate_coupon_with_valid_from_today(self):
        ...
        from dinematters.dinematters.tasks.coupon_tasks import auto_activate_scheduled_coupons
    ...
    def test_auto_deactivate_expired_coupon(self):
        ...
        from dinematters.dinematters.tasks.coupon_tasks import auto_deactivate_expired_coupons
...
class TestCouponExportImport(unittest.TestCase):
    ...
    def test_export_returns_csv_download(self):
        ...
        from dinematters.dinematters.api.coupons import export_coupons
    ...
    def test_import_creates_new_coupons(self):
        ...
        from dinematters.dinematters.api.coupons import import_coupons
